...
public class FreeBoardDBQuery {
	...
	public static final String SQL_FREEBOARD_FILE_INSERT = 
			"INSERT INTO BOARDFILE VALUES "
			+ "(FILE_ID_SEQ.nextval, ?, ?, ?, 1, WRITE_ID_SEQ.CURRVAL)";
	
	public static final String SQL_FREEBOARD_FILE_SELECT =
			"SELECT * FROM BOARDFILE "
			+ "WHERE FILESEQ = ? AND WRITE_ID = ? AND BOARD_ID = 1";
	
	public static final String SQL_FREEBOARD_FILE_DELETE = 
			"DELETE FROM BOARDFILE WHERE WRITE_ID = ?";
	
	public static final String SQL_FREEBOARD_TOTAL_CNT = 
