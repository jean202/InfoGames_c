...
<body>
	...
	<center>
		...
		<br>
		<br>
		<form name="frm" action="updateAcc.do" method="post"
			onsubmit="return chkSubmit()">
			<table>
				<tr>
					<th>비밀번호:</th>
					<td><input class="suip" type="password" name="pw"
						maxlength="25" /></td>
					</tr>
					<tr>
					<th>비밀번호확인:</th>
					<td><input class="suip" type="password" name="chkPw"
						maxlength="25" /></td>
				</tr>
			</table>
			<p>
			...
			<p>
				<button class="btn3" onclick="location.href='welcome.do'">회원창으로
					이동</button>
		</form>
	</center>
</body>
