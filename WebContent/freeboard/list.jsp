...
<a class="navbar-brand mr-auto mr-lg-0" style="font-size: xx-large; float: left; 
color: #ffffff; text-decoration: none; text-align: left;" href="../mainpage/GameRanking.do">InfoGames</a>

<a style="font-size: xx-large; color: #ffffff; float: center; text-decoration: none; text-align:center;" href="list.do">자유게시판</a>
