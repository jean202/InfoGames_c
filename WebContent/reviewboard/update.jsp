...
<a style="font-size: xx-large; color: #ffffff; text-decoration: none; text-align:center" href="list.do">리뷰게시판</a>
...
업로드 파일1:<%=originalFileName1%></td><th class="tab1">업로드 파일2:<%=originalFileName1 %>
