...
<%
	ReviewBoardDTO[] arr = (ReviewBoardDTO[])request.getAttribute("list");
%>
...
<a style="font-size: xx-large;float:center; color: #ffffff; text-decoration: none; text-align:center" href="list.do">리뷰게시판</a>
...
<td class="c3">조회수 <%= viewcnt %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;평가점수:<%=rating %></td>
</tr>
<tr>
<td  id="sbb" colspan="3">
<div id="subject">
...
<td class = "skyborder" colspan="2" style="width:50%">업로드 파일2:<a href="FileDownload.do?originalFileName=<%=originalFileName2%>&systemFileName=<%=systemFileName2%>"><%=originalFileName1 %></a>
<%} else if(originalFileName1 != null){ %>
<td class = "skyborder" >업로드 파일1:<a id="list" href="FileDownload.do?originalFileName=<%=originalFileName1%>&systemFileName=<%=systemFileName1%>"><%=originalFileName1%></a>
<%} %></td></tr>
</table>
</div>
<br>
